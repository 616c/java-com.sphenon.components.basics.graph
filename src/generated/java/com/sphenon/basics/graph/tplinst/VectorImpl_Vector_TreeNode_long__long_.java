...
public class VectorImpl_Vector_TreeNode_long__long_
  implements Vector_Vector_TreeNode_long__long_,
             VectorOptimized<Vector_TreeNode_long_>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_Vector_TreeNode_long__long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_Vector_TreeNode_long__long_ create (CallContext context) {
        return new VectorImpl_Vector_TreeNode_long__long_(context);
    }

    protected VectorImpl_Vector_TreeNode_long__long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_Vector_TreeNode_long__long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_Vector_TreeNode_long__long_(context, vector);
    }
    ...
    public Vector_TreeNode_long_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Vector_TreeNode_long_) vector.elementAt((int) index);
    ...
    public boolean contains(CallContext context, Vector_TreeNode_long_ item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, Vector_TreeNode_long_ item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, Vector_TreeNode_long_ item, VectorOptimized.Notifier<Vector_TreeNode_long_> notifier) {
