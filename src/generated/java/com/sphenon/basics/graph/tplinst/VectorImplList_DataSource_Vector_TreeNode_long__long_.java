...
public class VectorImplList_DataSource_Vector_TreeNode_long__long_
  implements Vector_Vector_TreeNode_long__long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Vector_TreeNode_long__long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Vector_TreeNode_long__long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Vector_TreeNode_long__long_(context, vector_source);
    }

    public Vector_TreeNode_long_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Vector_TreeNode_long_) vector_source.get(context).get((int) index);
